...
<body class="gray-bg">
						...
						<input type="hidden" id="contentHtml" name="content"> 
							<div class="col-sm-12">
		                            <div class="form-group">
		                                ...
		                                <div class="col-sm-4 forms">
		                                    <input type="text" class="form-control input_Keys" name="title" value="">                                                                          
		                                </div > 
                            ...
                            <div class="form-group">
	                                ...
	                                <div class="col-sm-9 forms">
	                                    <input type="text" class="form-control input_Keys" name="slavetitle" value="">                                                                          
	                                </div> 
                            </div>
                            </div>
                         ...
                         <div class="col-sm-12">
                          ...
                          <label class="col-sm-1 control-label text-left"></label>
                                <textarea style="height: 450px"  autocomplete="off" id="text" name="content1" class="markdown-textarea input_Keys" ></textarea>
                            </div>
                           </div>
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									...
									<button class="btn btn-success" type="button" onclick="sub(4)">添&nbsp;&nbsp;加</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	$("#cateId").val(cateVal);
	$("#type").val(type);
	$.post("/user/article/add",$("#forms").serialize(),function(rs){
	if(rs.code<0){
